...
from utils import predQ, adf_test, invert_transformation, forecast_accuracy

def run_mlp_loop(result_log = None, pred_df = None, start_val= 0,
    ...
    for n,t in enumerate(targets):
        ...
        # forecaster.fit(y=y_train exog=X_test)
        preds = forecaster.predict(steps=48, exog=X)
